...
( For the curious, I have wrote something around the swap test (with the calculation missing in the original Seth's paper in [here](swapdistances), [here](failed), and [here](rewriting) ). The QFDC is explained on this website [here](qfdc).)
